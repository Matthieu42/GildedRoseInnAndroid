...
public class GildedRoseApp extends Application {
    public ArrayList<AbstractItem> items = new ArrayList<>(Arrays.asList(new AgedBrieItem( 2, 0,20),
    ...
    public ArrayList<AbstractItem> inventory = new ArrayList<>();

    public GildedRose gildedRose = new GildedRose(inventory);
